#ifndef _ORBITA2D_SYSTEM_HWI
#define _ORBITA2D_SYSTEM_HWI
...
class Orbita2dSystem : public hardware_interface::SystemInterface
{
public:
    RCLCPP_SHARED_PTR_DEFINITIONS(Orbita2dSystem)
...
private:
  ...
  double hw_states_axis_sensors_[2];
