...
uint32_t orbita2d_get_raw_motors_position(uint32_t uid, double (*raw_motors_position)[2]);

uint32_t orbita2d_get_axis_sensors(uint32_t uid, double (*axis_sensors)[2]);
