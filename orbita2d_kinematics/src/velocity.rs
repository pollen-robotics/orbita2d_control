...
impl Orbita2dKinematicsModel {
    ...
    ///
    /// # Arguments
    /// * input_velocity - Input velocity on each motor
    /// # Returns
    /// * Output oriented velocity
    ...
    ///
    /// # Arguments
    /// * output_velocity - target output oriented velocity
    /// # Returns
    /// * Necessary input velocity on each motor
